...
Every PVE entity in virtdeck is uniquely identified by a typed ID.
...
StorageRepository) — see virtdeck/domain/repositories.py.
"""
...
class HostId:
    ...
    host_name: virtdeck config name (unique, e.g. 'hv01.bala.ltn.linru.grp')
...
class VmId:
    ...
    host_name: virtdeck config name
