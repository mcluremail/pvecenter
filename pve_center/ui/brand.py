"""Бренд PVE Center: знак и локап для интерфейса.
...
перекрашивается темами); слово «Center» в локапе следует цвету текста
темы (Color.TEXT).
"""
...
class BrandWidget(QWidget):
    """Локап в тулбаре: знак + «PVE Center» (PVE оранжевый, Center — тема)."""
    ...
    def restyle(self):
        ...
        self._wordmark.setText(
            f'<span style="color:{ORANGE};">PVE</span>'
            f'<span style="color:{Color.TEXT};">Center</span>'
        )
