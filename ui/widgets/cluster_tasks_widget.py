...
class ClusterTasksWidget(QWidget):
    def __init__(self, parent=None):
        ...
        # Фиксируем ширину только для времени и пользователя
        self.table.setColumnWidth(0, 160)   # Начало
        self.table.setColumnWidth(1, 160)   # Окончание
        self.table.setColumnWidth(3, 120)   # Пользователь

        # Статус и Описание получают одинаковое оставшееся пространство
    ...
    def set_tasks(self, tasks):
        """tasks – список словарей, возвращённых /cluster/tasks"""
